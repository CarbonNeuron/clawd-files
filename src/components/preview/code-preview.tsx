 ...
 * The HTML is generated server-side by the trusted Shiki highlighting engine,
 * which produces safe HTML with spans for syntax tokens — no user-controlled
 * HTML is passed through. The content is escaped by Shiki before rendering.
 */
